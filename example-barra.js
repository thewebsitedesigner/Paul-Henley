...
LMSimpleMenuBuilder('SimpleMenu1', LMSimpleMenuConfigTemplate['menu_03'].html, LMSimpleMenuConfigTemplate['menu_03'].css); var menu_SimpleMenu1 = LMSimpleMenuCool('SimpleMenu1', {orientation: 'horizontal', animation: 'fade', autodocked: false});
...
Henley[objindex++] = LMDiv("Line2",1,1,0,null,0,null,null,null,null,0);
branchlist = new Array();
...
Henley[objindex++] = LMDiv("Line3",1,1,0,null,0,null,null,null,null,0);
branchlist = new Array();
...
Henley[objindex++] = LMDiv("SECTION_SERVICES",1,1,0,null,0,null,null,null,null,0);
Henley[objindex++] = LMDiv("Panel4",1,1,0,null,0,null,null,null,null,0);
Henley[objindex++] = LMImage("Img9",1,1,0,null,0,null,null,null,null,0);
...
branchlist = new Array();
Henley[objindex++] = LMText("Obj29",1,1,0,null,0,null,branchlist,null,null);
branchlist = new Array();
Henley[objindex++] = LMText("Obj30",1,1,0,null,0,null,branchlist,null,null);
...
Henley[objindex++] = LMDiv("Panel14",1,1,0,DoorOpenH,0,null,null,null,null,0);
...
Henley[objindex++] = LMImage("Img6",1,1,0,null,0,null,null,null,null,0);
