...
LMSimpleMenuBuilder('SimpleMenu1', LMSimpleMenuConfigTemplate['menu_10'].html, LMSimpleMenuConfigTemplate['menu_10'].css); var menu_SimpleMenu1 = LMSimpleMenuCool('SimpleMenu1', {orientation: 'horizontal', animation: 'fade', autodocked: false});
...
Henley[objindex++] = LMDiv("Box12",1,1,0,null,0,null,null,null,null,0);
branchlist = new Array();
...
objlist[3] = "Box3";
objlist[4] = "Box4";
Henley[objindex++] = LMGroup("Groupe1",1,objlist);
...
Henley[objindex++] = LMDiv("Box18",1,1,0,null,0,null,null,null,null,0);
Henley[objindex++] = LMDiv("But6",1,1,0,null,0,null,null,null,null,0);
Henley[objindex++] = LMDiv("Box19",1,1,0,null,0,null,null,null,null,0);
...
Henley[objindex++] = LMDiv("But15",1,1,0,null,0,null,new LMBranchEx("0","./website-building.html",null,0.0,null,null,1,1,1,1,1,1,0,640,480,"_self"),null,null,1);
//---------------------------------------------------------------------------------------------
}
}catch(e) {
alert(e.message);
